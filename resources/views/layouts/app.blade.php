...
<!-- Mirrored from shopery.netlify.app/main/home-04.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Apr 2022 16:59:46 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta http-equiv="X-UA-Compatible" content="ie=edge" />
        <title>Homepage-04 | Shopery</title>
        <link rel="icon" type="image/png" href="{{ asset('front') }}/images/favicon/favicon-16x16.png" />
    ...
    <body>
       ...
       @include('layouts/header')
        ...
        <!-- Footer Section end  -->
        <!-- Modal -->
        <div class="modal fade newsletter-popup" id="newsletter" tabindex="-1" aria-labelledby="newsletterLabel" aria-hidden="true">
                        ...
                        <div class="row newsletter-popup__content">
                            <div class="col-lg-5">
                                <div class="newsletter-popup__img-wrapper">
                                    <img src="{{ asset('front') }}/images/banner/banner-sm-18.png" alt="newsletter" />
                                </div>
                            </div>
                            <div class="col-lg-7">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="gallery-view">
                                        ...
                                        <div class="swiper-container gallery-items-slider swiper-container-initialized swiper-container-vertical swiper-container-pointer-events">
                                            <div class="swiper-wrapper" id="swiper-wrapper-107ed06721010fb13b8" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(0px, -420px, 0px);">
                                                <div class="gallery-item swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 12" style="height: 105px;">
                                                    <img src="{{ asset('front') }}/images/product-details/img-01.png" alt="Slide 01" />
                                                </div>
                                                <div class="gallery-item swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="2 / 12" style="height: 105px;">
                                                    <img src="{{ asset('front') }}/images/product-details/img-02.png" alt="Slide 02" />
                                                </div>
                                                <div class="gallery-item swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 12" style="height: 105px;">
                                                    <img src="{{ asset('front') }}/images/product-details/img-03.png" alt="Slide 03" />
                                                </div>
                                                <div class="gallery-item swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="3" role="group" aria-label="4 / 12" style="height: 105px;">
                                                    <img src="{{ asset('front') }}/images/product-details/img-04.png" alt="Slide 04" />
                                                </div>
                                    ...
                                    <div class="gallery-main-image products__gallery-img--lg">
                                        <img class="product-main-image" src="{{ asset('front') }}/images/product-details/img-01.png" alt="Slide 01" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6">
        ...
        <script src="{{ asset('front') }}/lib/js/jquery.min.js"></script>
        <script src="{{ asset('front') }}/lib/js/venobox.min.js"></script>
        <script src="{{ asset('front') }}/lib/js/swiper-bundle.min.js"></script>
        <script src="{{ asset('front') }}/lib/js/bvselect.js"></script>
        <script src="{{ asset('front') }}/lib/js/bootstrap.bundle.min.js"></script>
        <script src="{{ asset('front') }}/lib/js/jquery.syotimer.min.js"></script>
        <script src="{{ asset('front') }}/js/main.js"></script>
        <script src="{{ asset('front') }}/js/home4.js"></script>
        <!-- Purchase Button -->
...
<!-- Mirrored from shopery.netlify.app/main/home-04.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Apr 2022 17:00:05 GMT -->
</html>
