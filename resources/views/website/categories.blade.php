                    ...
                    <div class="col-lg-9">
                        <div class="filter--search-result">
                            <div class="sort-list">
                                ...
                                </select><div id="bv_1369" data-search="false" class="bv_mainselect"><div id="main_1369" style="width:100%;" class="bv_atual bv_background">Latest<i id="arrow_1369" class="arrows_bv arrow down"></i></div><ul id="ul_1369" class="bv_ul_inner bv_background" style="width: 150px;"><li class=" ">  Latest</li><li class=" ">  Newest</li><li class=" ">  Oldest</li></ul></div>
                            </div>
                                                ...
                                                <div class="categories">
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="fruit">
                                                            <label class="form-check-label" for="fruit"> Fresh Fruit (25) <span class="current">(134)</span> </label>
                                                        </div>
                                                    </div>
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="vegetable" checked="">
                                                            <label class="form-check-label" for="vegetable"> Fresh Fruit <span class="current">(150)</span> </label>
                                                        </div>
                                                    </div>
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="cooking" checked="">
                                                            <label class="form-check-label" for="cooking"> Cooking <span class="current">(54)</span> </label>
                                                        </div>
                                                    </div>
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="snacks" checked="">
                                                            <label class="form-check-label" for="snacks"> Snacks <span class="current">(47)</span> </label>
                                                        </div>
                                                    </div>
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="beverage" checked="">
                                                            <label class="form-check-label" for="beverage"> Beverages <span class="current">(43)</span> </label>
                                                        </div>
                                                    </div>
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="health" checked="">
                                                            <label class="form-check-label" for="health"> Beauty &amp; Health <span class="current">(38)</span> </label>
                                                        </div>
                                                    </div>
                                                    <div class="categories-item">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="category" id="bread" checked="">
                                                            <label class="form-check-label" for="bread"> Bread &amp; Bakery<span class="current">(15)</span> </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="accordion-item shop-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse shop-collapse collapse show" aria-labelledby="shop-item-accordion--two" data-bs-parent="#shop">
                                            <div class="price-range-slider">
                                                <div id="priceRangeSlider" class="noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr"><div class="noUi-base"><div class="noUi-connects"><div class="noUi-connect" style="transform: translate(1.33333%, 0px) scale(0.04, 1);"></div></div><div class="noUi-origin" style="transform: translate(-986.667%, 0px); z-index: 5;"><div class="noUi-handle noUi-handle-lower" data-handle="0" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="0.0" aria-valuemax="80.0" aria-valuenow="20.0" aria-valuetext="20.00"><div class="noUi-touch-area"></div><div class="noUi-tooltip">20.00</div></div></div><div class="noUi-origin" style="transform: translate(-946.667%, 0px); z-index: 6;"><div class="noUi-handle noUi-handle-upper" data-handle="1" tabindex="0" role="slider" aria-orientation="horizontal" aria-valuemin="20.0" aria-valuemax="1500.0" aria-valuenow="80.0" aria-valuetext="80.00"><div class="noUi-touch-area"></div><div class="noUi-tooltip">80.00</div></div></div></div></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseThree" class="accordion-collapse shop-collapse collapse show" aria-labelledby="shop-item-accordion--three" data-bs-parent="#shop">
                                        <div class="accordion-body shop-body">
                                            <div class="ratings">
                                                ...
                                                <div class="ratings--list-item">
                                                    <div class="form-check d-flex align-items-center">
                                                        <input class="form-check-input" type="checkbox" name="ratings" id="four">
                                                ...
                                                <div class="ratings--list-item">
                                                    <div class="form-check d-flex align-items-center">
                                                        <input class="form-check-input" type="checkbox" name="ratings" id="three">
                                                ...
                                                <div class="ratings--list-item">
                                                    <div class="form-check d-flex align-items-center">
                                                        <input class="form-check-input" type="checkbox" name="ratings" id="two">
                                                ...
                                                <div class="ratings--list-item">
                                                    <div class="form-check d-flex align-items-center">
                                                        <input class="form-check-input" type="checkbox" name="ratings" id="one">
                                    ...
                                    <a href="product-details.html" class="shop-sale-product-item">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <ul class="rating">
                                                ...
                                                <li>
                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M6.20672 8.94078L8.5711 10.4385C8.87335 10.6298 9.24835 10.3452 9.15872 9.99228L8.47585 7.30541C8.45656 7.23057 8.45878 7.1518 8.48227 7.07816C8.50575 7.00453 8.54954 6.93902 8.6086 6.88916L10.7288 5.12478C11.0071 4.89303 10.8638 4.43066 10.5057 4.40741L7.7371 4.22741C7.66255 4.22212 7.59105 4.19577 7.5309 4.15142C7.47075 4.10707 7.42444 4.04656 7.39735 3.97691L6.3646 1.37666C6.33648 1.30276 6.28656 1.23916 6.22146 1.19428C6.15636 1.1494 6.07916 1.12537 6.0001 1.12537C5.92103 1.12537 5.84383 1.1494 5.77873 1.19428C5.71364 1.23916 5.66372 1.30276 5.6356 1.37666L4.60285 3.97691C4.57581 4.04663 4.52952 4.10722 4.46937 4.15164C4.40922 4.19606 4.33768 4.22246 4.2631 4.22778L1.49447 4.40778C1.13672 4.43066 0.992723 4.89303 1.27135 5.12478L3.3916 6.88953C3.45059 6.93936 3.49434 7.00481 3.51782 7.07837C3.5413 7.15193 3.54356 7.23062 3.52435 7.30541L2.89135 9.79728C2.78372 10.2207 3.2341 10.5623 3.59635 10.3324L5.79385 8.94078C5.85561 8.90152 5.92728 8.88066 6.00047 8.88066C6.07366 8.88066 6.14533 8.90152 6.2071 8.94078H6.20672Z" fill="#cccccc"></path>
                                                    </svg>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <nav aria-label="Page navigation pagination--one" class="pagination-wrapper section--xl" style="padding-top: 20px;">
                          <ul class="pagination justify-content-center">
                              ...
                              <li class="page-item pagination-item"><a class="page-link pagination-link active" href="#">1</a></li>
                              <li class="page-item pagination-item"><a class="page-link pagination-link" href="#">2</a></li>
                              <li class="page-item pagination-item"><a class="page-link pagination-link" href="#">3</a></li>
                              <li class="page-item pagination-item"><a class="page-link pagination-link" href="#">4</a></li>
                              <li class="page-item pagination-item"><a class="page-link pagination-link" href="#">5</a></li>
                              <li class="page-item pagination-item"><p class="page-link pagination-link">...</p> </li>
                              <li class="page-item pagination-item"><a class="page-link pagination-link" href="#">21</a></li>
